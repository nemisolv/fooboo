function HeartEmotion() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 180 180">
      {' '}
      <defs>
        {' '}
        ...
        >
          {' '}
          <stop stopColor="#FFE874" offset="0%" /> <stop stopColor="#FFE368" stopOpacity={0} offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="10.82%"
          cy="52.019%"
        ...
        >
          {' '}
          <stop stopColor="#3B446B" offset="0%" /> <stop stopColor="#202340" offset="68.84%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="49.239%"
          cy="66.964%"
        ...
        >
          {' '}
          <stop stopColor="#E38200" offset="0%" /> <stop stopColor="#CD6700" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="50%"
          cy="29.807%"
        ...
        >
          {' '}
          <stop stopColor="#C71C08" stopOpacity={0} offset="0%" /> <stop stopColor="#C71C08" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="2.243%"
          cy="4.089%"
        ...
        >
          {' '}
          <stop stopColor="#EDA83A" offset="0%" /> <stop stopColor="#FFDC5E" offset="100%" />{' '}
        </radialGradient>{' '}
        <radialGradient
          cx="100%"
          cy="7.011%"
        ...
        >
          {' '}
          <stop stopColor="#F4B248" offset="0%" /> <stop stopColor="#FFDD5F" offset="100%" />{' '}
        </radialGradient>{' '}
        <linearGradient x1="50%" y1="95.035%" x2="50%" y2="7.417%" id="b">
          {' '}
          <stop stopColor="#F28A2D" offset="0%" /> <stop stopColor="#FDE86F" offset="100%" />{' '}
        </linearGradient>{' '}
        <linearGradient x1="49.985%" y1="-40.061%" x2="49.985%" y2="111.909%" id="i">
          {' '}
          <stop stopColor="#482314" offset="0%" /> <stop stopColor="#9A4111" offset="100%" />{' '}
        </linearGradient>{' '}
        <linearGradient x1="52.727%" y1="31.334%" x2="28.964%" y2="102.251%" id="o">
          {' '}
          <stop stopColor="#F34462" offset="0%" /> <stop stopColor="#CC0820" offset="100%" />{' '}
        </linearGradient>{' '}
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g fillRule="nonzero">
          ...
          <g transform="translate(.005 -.004)">
            {' '}
            <use fill="url(#b)" xlinkHref="#a" /> <use fill="url(#c)" xlinkHref="#a" />{' '}
            <use fill="url(#d)" xlinkHref="#a" /> <use fill="url(#e)" xlinkHref="#a" />{' '}
            <use fill="url(#f)" xlinkHref="#a" /> <use fill="url(#g)" xlinkHref="#a" />{' '}
        ...
        <g fillRule="nonzero">
          {' '}
          <use fill="url(#o)" xlinkHref="#n" /> <use fill="url(#p)" xlinkHref="#n" />{' '}
          <use fill="url(#q)" xlinkHref="#n" /> <use fill="url(#r)" xlinkHref="#n" />{' '}
          <use fill="url(#s)" xlinkHref="#n" /> <use fill="url(#t)" xlinkHref="#n" />{' '}
          <use fill="url(#u)" xlinkHref="#n" /> <use fillOpacity=".5" fill="url(#v)" xlinkHref="#n" />{' '}
        </g>{' '}
