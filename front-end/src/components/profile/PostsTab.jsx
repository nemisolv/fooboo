    ...
    <div className='flex flex-col gap-3'>
      ...
      {userProfilePostsLoading ? (
        ...
        <div className='flex  gap-10'>
         ...
         <p>DOB: {userProfile?.details?.birthDay + ' ' +  userProfile?.details?.birthMonth + ' ' + userProfile?.details?.birthYear}</p>
         ...
         {userProfilePosts && userProfilePosts?.metadata?.length > 0 ? (
            ...
            <div className='text-center flex-center w-full '><h1>No Posts yet</h1></div>
          )}
         </div>
        </div>
      )}
